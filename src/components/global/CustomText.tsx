...
interface CustomTextProps {
    variant?: Variant;
    fontFamily?: "Okra-Bold" | "Okra-Regular" | "Okra-Light" | "Okra-Medium" | "Okra-SemiBlack";
    fontSize?: number;
    color?: string;
...
const CustomText: FC<CustomTextProps> = ({ variant, fontFamily="Okra-Medium", fontSize, style, color, children, numberOfLines, onLayout, ...props}) => {
    ...
    return (
        <Text onLayout={onLayout} style={[styles.text, { color: color || Colors.text, fontSize: computedFontSize}, fontFamilyStyle, style]} numberOfLines={numberOfLines ? numberOfLines : undefined} {...props}>
            {children}
        </Text>
    );
};
